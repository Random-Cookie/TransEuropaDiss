...
if __name__ == "__main__":
	...
	game_driver.simulate([ClosestFirst("Closest First"), ClosestX("Closest 2", 2)])
	game_driver.simulate([ClosestFirst("Closest First"), ClosestX("Closest 3", 3)])
	game_driver.simulate([ClosestFirst("Closest First"), ClosestX("Closest 4", 4)])
	print("--------------------------------------------------")
	print("COMPLETED")
	print("--------------------------------------------------")