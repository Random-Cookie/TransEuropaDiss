...
class TrackOptimised(BasicBot):
	def __init__(self, name):
		BasicBot.__init__(self, name)
...
class ClosestFirst(TrackOptimised):
	def __init__(self, name):
		TrackOptimised.__init__(self, name)

	def choose_start_pos(self, game_board: GameBoard) -> str:
		self._sort_cities(game_board)
		return TrackOptimised.choose_start_pos(self, game_board)
...
class FarthestFirst(ClosestFirst):
	def _sort_cities(self, game_board: GameBoard):
		ClosestFirst._sort_cities(self, game_board)
		self._target_cities.reverse()
